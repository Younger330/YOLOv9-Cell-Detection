...
class yolov9_heatmap:
    ...
    def post_process(self, result):
        result = non_max_suppression(result, conf_thres=self.conf_threshold, iou_thres=0.3)[0]
        return result
...
def get_params():
    params = {
        'weight': 'runs/train/BMblood/CP-yolov9-c/weights/best-converted.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('../data/BMBlood/IN/val/images', 'runs/heatmap/IN-gradcam/val')